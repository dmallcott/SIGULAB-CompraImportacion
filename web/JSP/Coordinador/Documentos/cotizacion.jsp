        ...
        <tbody>
            ...
            <tbody id="tabla" style="overflow: scroll">
                ...
                for (var x = 0; x < numeroItems; x++) {
                    ...
                    cell2.innerHTML = '<input required type="text" maxlength="50" name="nombre'+x+'"/>';
                    cell3.innerHTML = '<input required type="text" placeholder="12,00" pattern="[0-9]*[,][0-9]*" title="Utilize decimales positivos." name="precio'+x+'"/>';
                    cell4.innerHTML = '<input required type="text" maxlength="20" name="tiempo'+x+'"/>';
                    cell5.innerHTML = '<input required type="text" maxlength="20" name="condicion'+x+'"/>';
                    cell6.innerHTML = '<input required type="text" maxlength="200" name="garantia'+x+'"/>';
